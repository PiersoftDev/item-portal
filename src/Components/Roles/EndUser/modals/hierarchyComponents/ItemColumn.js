...
function ItemColumn({ multiColumnState, setMultiColumnState }) {
  ...
  const handleSelect = (name) => {
    if (selected === name) {
      ...
      let newMultiColumnState = { ...stateTobeChangedTo }
      newMultiColumnState[ITEM_COLUMN] = {
        isSelected: true,
        value: name,
      }
  ...
  //     if (multiColumnState[ITEM_COLUMN].isSelected) {
  //       let newMultiColumnState = { ...stateTobeChangedTo }
  //       newMultiColumnState[ITEM_COLUMN] = {
  //         isSelected: false,
  //         value: '',
  ...
  return (
    <Wrapper>
      <div className="category-header">
        <div className="catgeory-header-title">{ITEM_COLUMN}</div>
        {/* <Input
