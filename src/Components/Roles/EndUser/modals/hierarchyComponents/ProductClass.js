...
function ProductClass({ multiColumnState, setMultiColumnState }) {
  ...
  //     if (multiColumnState[PRODUCT_CLASS_COLUMN].isSelected) {
  //       let newMultiColumnState = { ...stateTobeChangedTo }
  //       newMultiColumnState[PRODUCT_CLASS_COLUMN] = {
  //         isSelected: false,
  //       }
  ...
  return (
    <Wrapper>
      <div className="category-header">
        <div className="catgeory-header-title">{PRODUCT_CLASS_COLUMN}</div>
        {/* <Input
