...
function ProductTypeColumn({ multiColumnState, setMultiColumnState }) {
  ...
  //     newMultiColumnState[PRODUCT_TYPE_COLUMN] = {
  //       isSelected: true,
  //     }
  ...
  //     if (multiColumnState[PRODUCT_TYPE_COLUMN].isSelected) {
  //       let newMultiColumnState = { ...stateTobeChangedTo }
  //       newMultiColumnState[PRODUCT_TYPE_COLUMN] = {
  //         isSelected: false,
  //       }
  ...
  return (
    <Wrapper>
      <div className="category-header">
        <div className="catgeory-header-title">{PRODUCT_TYPE_COLUMN}</div>
        {/* <Input
